...
public class ItemCatService extends BaseService<ItemCat> {
    ...
    private static final String REDIS_KEY = "TAOTAO_MANAGE_ITEM_CAT_ALL";
    ...
    public ItemCatResult queryAllToTree() {
        try {
            // 从缓存中命中
            String jsondata = this.redisServer.get(REDIS_KEY);
        ...
        try {
            this.redisServer.set(REDIS_KEY, MAPPER.writeValueAsString(result), REDIS_TIME);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return result;
